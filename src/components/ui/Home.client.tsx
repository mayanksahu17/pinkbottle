      ...
      <main>
        <section className="bg-white py-24">
          ...
          <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            {" "}
            {/* Wider container and larger gap */}
            <div>
              <div className="inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent bg-secondary text-secondary-foreground hover:bg-secondary/80 mb-4 font-sans font-light md:font-logo">
              ...
              <p className="text-xl mb-8 text-gray-600">
                We build a human-assisted AI that applies to jobs on your
                behalf. You can focus on networking and interview Prep.
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
              <div>
                ...
                <p className="text-xl mt-4 text-gray-700">
                  of our clients land an interview within the first month
                </p>
              </div>
              <div>
                <span className="text-6xl font-bold text-black-400">40x</span>
                <p className="text-xl mt-4 text-gray-700">
                  more interviews with Scale than applying on your own
                </p>
              </div>
              <div>
                <span className="text-6xl font-bold text-black-400">200x</span>
                <p className="text-xl mt-4 text-gray-700">
                  more efficient than the traditional job search
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
              ...
              <div className="bg-white rounded-xl overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-500 ease-in-out">
                <div className="p-6 text-center">
                  ...
                  <p className="text-gray-600">
                    SDE at Figma | EX - Netflix, NASA
                  </p>
                  <p className="text-gray-500 mt-4">
                    "It is personally gratifying to see Jobify helping landing
                    in their full time after a long hustle"
                  </p>
                </div>
              </div>
              {/* ... other cards ... */}
              <div className="bg-white rounded-xl overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-500 ease-in-out">
                <div className="p-6 text-center">
                  ...
                  <p className="text-gray-600">
                    SDE - Microsoft | Youtuber - 1.11 M Subscriber
                  </p>
                  <p className="text-gray-500 mt-4">
                    "It is personally gratifying to see my clients landing in
                    their full time after a long hustle"
                  </p>
                </div>
              </div>
              <div className="bg-white rounded-xl overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-500 ease-in-out">
          ...
          <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="divide-y divide-gray-300">
              ...
              <details className="group py-4">
                ...
                <p className="mt-4 leading-relaxed">
                  The number of recruiter calls varies depending on your skills,
                  experience, and the job market.
                </p>
              </details>
              <details className="group py-4">
                <summary className="text-lg font-medium cursor-pointer flex justify-between items-center">
        ...
        <section className="bg-white py-8">
          <div className="max-w-6xl mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-4">
              Have more? Let's catch up over a call
            </h2>
            <p className="mb-6">
        ...
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-4">
            ...
            <p className="mb-12 text-center">
              All of them are top of their game in Careers and Immigration. Here
