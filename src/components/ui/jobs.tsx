    ...
    <aside className={`fixed inset-y-0 left-0 z-40 w-64 bg-[#f7f7f7] p-4 transform transition-transform duration-300 ease-in-out h-screen ${isAsideMenuOpen ? "translate-x-0" : "-translate-x-full"} md:relative md:translate-x-0 md:block shadow-xl`}>
      ...
      <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-6 pt-[4rem]">
        <div className="flex items-center">
          <h1 className="font-semibold text-lg md:text-2xl">Hey {user?.firstName}, We are still working on this. Soon you can checkout jobs we applied here!</h1>
        </div>
  ...
  <div className="relative flex-1 max-w-lg">
    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
      <svg className="h-5 w-5 text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
        ...
        <path fill-rule="evenodd" d="M12.293 12.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414-1.414l4-4z" clip-rule="evenodd" />
