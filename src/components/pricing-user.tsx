    ...
    <div className="bg-white text-gray-900">
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          <div className="border border-gray-200 rounded-lg p-6">
            ...
            <Link href="https://buy.stripe.com/test_6oEeXQboMc8X8tG6oo">
              <button className={styles.getStartedButtonother}>
                Get started
              </button>
            </Link>
          </div>
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <p className="mt-4 text-center text-base font-light text-gray-600">
          We know that you would want to evaluate the value add that we bring to
          the table for the investment you make. See how productively can you
          use that time and how we fare with the standard plan.
        </p>
      ...
      <div className="bg-gradient-to-b from-gray-100 to-gray-200">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-6 text-center text-lg font-light text-blue-800">
            We follow a Pro Rata Cancellation Policy and you can cancel your
            plan anytime. No questions asked.
          </p>
          <div className="mt-8 p-6 bg-white shadow-lg rounded-lg">
            <p className="text-md text-gray-800">
              <span className="font-semibold">Refund Amount:</span> Plan Price -
              (Pro Rata Cost + Payment Gateway Fee + Turnaround Fee)
            </p>
            <p className="text-md text-gray-800">
              <span className="font-semibold">Payment Gateway Fee</span> stands
              at 3% and <span className="font-semibold">Turnaround Fee</span> is
              $30 for all plans.
            </p>
            <div className="mt-6 py-4 px-6 bg-blue-50 rounded-lg">
              ...
              <p className="text-md text-gray-700">
                Let's say you took our $399 plan for 1000 applications and
                started our service. 5 days and 100 submitted applications later
                you decide to cancel our service, then the refund amount is:
              </p>
              ...
              <p className="text-lg text-gray-800 font-semibold">= $317.13</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="border border-gray-200 rounded-lg p-6">
            ...
            <p className="mt-4 text-sm text-gray-600">
              Get assistance from our purpose built AI tools while you apply on
              your own. Increase your Productivity.
            </p>
          ...
          <div className="flex justify-between">
            <div>
              <p className="text-sm text-gray-500">
                Made with <HeartIcon className="text-red-500 inline" /> by 2
                laid off guys in{""}
